...
public class AustraliaActivity extends AppCompatActivity {
            ...
            protected void onBindViewHolder(@NonNull UniversityViewHolder holder, final int position, @NonNull University model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(AustraliaActivity.this, UniversityDetails.class);
    ...
    public class UniversityViewHolder extends RecyclerView.ViewHolder {
        ...
        void setTvUniversityName(String universityName) {
            TypeFaceUtil.nunito_bold(AustraliaActivity.this, tvUniversityName);
